        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_storage_cells_sectors_sector_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    height = table.Column<double>(type: "double precision", nullable: false),
                    depth = table.Column<double>(type: "double precision", nullable: false),
                    in_storage = table.Column<bool>(type: "boolean", nullable: false),
                    in_processing = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_items_customers_customer_id",
                        column: x => x.customer_id,
                        principalTable: "customers",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "fk_items_storage_cells_id",
                        column: x => x.id,
            ...
            migrationBuilder.CreateIndex(
                name: "ix_items_customer_id",
                table: "items",
                column: "customer_id");

            migrationBuilder.CreateIndex(
                name: "ix_storage_cells_sector_id",
                table: "storage_cells",
                column: "sector_id");
        }
